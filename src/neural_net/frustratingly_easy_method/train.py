...
def union(dataset_dict, args, dump_path):
    ...
    for domain in domain_dict:
        ...
        train_dataset_dict['{0}_x'.format(domain)] = dataset_dict['{0}_x'.format(domain)][:size]
        test_dataset_dict['{0}_x'.format(domain)] = dataset_dict['{0}_x'.format(domain)][size:]
        train_dataset_dict['{0}_y_ga'.format(domain)] = dataset_dict['{0}_y_ga'.format(domain)][:size]
        test_dataset_dict['{0}_y_ga'.format(domain)] = dataset_dict['{0}_y_ga'.format(domain)][size:]
        train_dataset_dict['{0}_y_o'.format(domain)] = dataset_dict['{0}_y_o'.format(domain)][:size]
        test_dataset_dict['{0}_y_o'.format(domain)] = dataset_dict['{0}_y_o'.format(domain)][size:]
        train_dataset_dict['{0}_y_ni'.format(domain)] = dataset_dict['{0}_y_ni'.format(domain)][:size]
        test_dataset_dict['{0}_y_ni'.format(domain)] = dataset_dict['{0}_y_ni'.format(domain)][size:]
        train_dataset_dict['{0}_z'.format(domain)] = dataset_dict['{0}_z'.format(domain)][:size]
        test_dataset_dict['{0}_z'.format(domain)] = dataset_dict['{0}_z'.format(domain)][size:]
